...
import { AdminUser, ContentDocument, DbShape } from "../types/models.js";
...
const defaultContent = (): ContentDocument => ({
  hero: {
    ...
    summary:
      "I build scalable frontend and full-stack systems with strong focus on clean architecture, performance, and production readiness.",
...
const defaultUsers = async (): Promise<AdminUser[]> => {
...
const getDataPath = (): string => path.resolve(process.cwd(), config.dataFilePath);
