...
import { createAdminUser, getUsers, patchAdminUser, removeAdminUser, } from "../controllers/admin-users.controller.js";
...
adminRouter.put("/content/:section", requireRole(["super_admin", "editor"]), writeSection);
