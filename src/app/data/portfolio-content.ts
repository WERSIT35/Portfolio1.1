...
export const PROJECTS: Projects[] = [
  ...
  {
    projName: 'Provider',
    subname: 'Server-Authoritative Slot Prototype - Banana X Profile Build',
    date: 'May 8, 2026',
    about:
      'Provider is a runnable server-authoritative slot MVP built around a Banana X-style game profile. The prototype combines backend-controlled RNG outcomes, per-profile RTP configuration, public gameplay APIs, and a canvas-rendered client experience. It supports a 5 reel x 4 row layout, symbols-pay-anywhere wins with an 8-match minimum, tumble animations, free spins, retriggers, multiplier progression, buy-free-spins flow, game rules, health checks, and math simulation endpoints including 1M spin runs and streamed simulation output.',
    numOfPage: 0,
    duration: 'Node.js + Canvas + Slot Math Simulation',
    highlights: [
      'Server-authoritative RNG outcomes with client-rendered slot visuals',
      'Banana X profile wiring with multiple RTP modes: 96.38%, 94.40%, and 92.38%',
      'Tumble flow with animated drop, explode visuals, free spins, retriggers, and multiplier progression',
      'Public APIs for session init, spin, buy-free-spins, game rules, health, and simulation',
    ...
    featured: true,
    stack: ['Node.js', 'JavaScript', 'REST API Design', 'HTML5'],
    problem:
      'The project needed a believable slot-provider MVP where the server owns outcomes, the client stays presentation-focused, and the math profile can be repeatedly simulated before any certification conversation.',
    approach: [
      'Built backend-owned RNG spin outcomes and session-based gameplay APIs',
      'Modeled Banana X RTP profiles through math/game-rules-v2.json',
      'Implemented tumble sequencing with multiplier progression, free spins, retriggers, and buy-free-spins flow',
      'Rendered the gameplay client with canvas for dark, glassy, animated slot visuals',
      'Added batch and streamed simulation endpoints for repeated 1M spin validation runs',
    ],
    metrics: [
      { label: 'Layout', value: '5x4 reels' },
      { label: 'Max win cap', value: '20000x bet' },
      { label: 'Simulation', value: '1M spins' },
    ],
    lessons:
